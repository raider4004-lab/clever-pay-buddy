...
const CustomerList = ({ 
  ...
  const getStatusBadge = (status: string) => {
    const colors = {
      pending: "bg-finbot-gray-medium text-foreground",
        ...
        {filteredCustomers.length === 0 ? (
          ...
          <div className="space-y-4">
            {filteredCustomers.map((customer) => (
              <div key={customer.id} className="p-4 border border-finbot-gray-medium rounded-lg hover:shadow-elegant transition-shadow">
